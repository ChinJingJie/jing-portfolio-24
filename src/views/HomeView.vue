...
const paragrphs = ref([
  { content: "I am Jing Jie, hailing from Johor, Malaysia, and as a member of Gen Z, I find solace in the quietude of a crowd. However, my demeanor transforms into that of an extrovert when the conversation veers towards topics of coding or technology. The thrill of successfully developing new features for websites and mobile apps fills me with immense joy, thanks to the coding skills I have honed." },
...
<template>
  <div id="story" class="relative max-h-screen pb-5 md:py-5 md:overflow-y-scroll">
